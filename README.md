...
| **improve-codebase-architecture** | Explore a codebase to find architectural improvement opportunities, focusing on deepening shallow modules. Outputs as Pi todos. **Pi-specific.** |
...
| **prd-to-todos** | Break a PRD into independently-grabbable Pi todos using tracer-bullet vertical slices. Outputs to Pi's todo system instead of GitHub issues. **Pi-specific.** |

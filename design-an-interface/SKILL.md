...
attribution: Inspired by https://github.com/mattpocock/skills (design-an-interface)
---
...
Explore 3+ radically different designs sequentially. Each design must be **radically different**.
...
- Don't let designs be too similar - enforce radical difference
